...
class Site_Management extends Component {
    constructor(props){
        super(props);
        this.state ={
...
<ul className="collection">
  ...
  {/* <span>Lorem ipsum dolor sit amet.</span> */}
      ...
      <div className="collapsible-body">
          <Link to='#back'> 
          <button className="btn myBtn" >Back</button>
          </Link>
      </div>
  </li>
            }
...
Set_Title=()=>{
  ...
  if(posts_interest === 'blocked'){
      display_page_title = 'BLOCKED USERS';
      // display_list = recent_posts;
    }else if(posts_interest === 'reported'){
        display_page_title = 'REPORTED USERS';
      //   display_list = your_posts;
    }else if(posts_interest === 'all'){
        display_page_title = 'USERS';
                        ...
                        <div className="col s12 m12 l8 xl8">
                            ...
                            {/* <div className="nav-wrapper pecific blue"> */}
                              ...
                              {/* <ul id="nav-mobile" className='center'> */}
                                {/* <li onClick={()=>{localStorage.setItem('interest', 'all')}}><Link to="#">All Users</Link></li> */}
                                {/* <li onClick={()=>{localStorage.setItem('interest', 'blocked')}}><Link to="#">Blocked</Link></li> */}
                            ...
                            <div className="row">
                                ...
                                There is no analytics to display, as system is under-development!
                            </div>
                            {/* <Content /> */}
                        </div>
                            </div>
...
export default connect(mapStateToProps, null)(Site_Management);