...
class users_Management extends Component {
    constructor(props){
        super(props);
        this.state ={
                    ...
                    <div className="row">
                        ...
                        <div className="col s12 m12 l8 xl8">
                            ...
                            <div className="row">
                                ...
                                There is no user to display, as system is under-development!
                            </div>
                            {/* <Content /> */}
                        </div>
                            </div>
...
export default connect(mapStateToProps, null)(users_Management);